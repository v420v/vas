...
fn canon_to_kind(canon string) InstrKind {
	return match canon {
		'MOV' { InstrKind.mov }
		'ADD' { InstrKind.add }
		'OR' { InstrKind.instr_or }
		'ADC' { InstrKind.adc }
		'SBB' { InstrKind.sbb }
		'AND' { InstrKind.and }
		'SUB' { InstrKind.sub }
		...
		'JNS' { InstrKind.jns }
		'SETO' { InstrKind.seto }
		'SETNO' { InstrKind.setno }
		'SETB' { InstrKind.setb }
		'SETNB' { InstrKind.setnb }
		'SETAE' { InstrKind.setae }
		'SETE' { InstrKind.sete }
		'SETNE' { InstrKind.setne }
		'SETBE' { InstrKind.setbe }
		'SETA' { InstrKind.seta }
		'SETPO' { InstrKind.setpo }
		'SETL' { InstrKind.setl }
		'SETGE' { InstrKind.setge }
		'SETLE' { InstrKind.setle }
		'SETG' { InstrKind.setg }
		'MOVZX' { InstrKind.movzx }
		'MOVSX' { InstrKind.movsx }
		'MOVSXD' { InstrKind.movsx }
		'MOVABSQ' { InstrKind.movabsq }
		else { InstrKind.@none }
	}
}
