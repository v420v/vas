...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/tmp/probe" "dbg.c" md5 0x2c7fa9a609df7a2f7e9f545c2571989d
	.loc	0 1 0                           # dbg.c:1:0
...
# %bb.0:
	...
	movl	$0, -4(%rbp)
.Ltmp0:
	.loc	0 1 18 prologue_end             # dbg.c:1:18
	xorl	%eax, %eax
	.loc	0 1 18 epilogue_begin is_stmt 0 # dbg.c:1:18
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Ltmp1:
...
.Linfo_string1:
	.asciz	"dbg.c"                         # string offset=46
.Linfo_string2:
	.asciz	"/tmp/probe"                    # string offset=52
.Linfo_string3:
	.asciz	"main"                          # string offset=63
.Linfo_string4:
